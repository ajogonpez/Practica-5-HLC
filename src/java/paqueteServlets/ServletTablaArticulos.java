 ...
 * @author indes
 */
@WebServlet(name = "ServletTablaArticulos", urlPatterns = {"/ServletTablaArticulos"})
public class ServletTablaArticulos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"CSS/tablaCss.css\">");
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("</nav>");
            //Tabla de Articulos
            TablaArticulos.processRequest(request, response);
